      ...
      <div className="max-w-[1400px] mx-auto w-full space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500 text-[13px] mt-1">Identify and address competency deficits across teams.</p>
          </div>
          <div className="flex items-center gap-3">
            <select className="bg-white border border-slate-200 rounded-lg px-4 py-2 font-medium text-[12px] text-slate-600 focus:outline-none focus:ring-1 focus:ring-[#6C1D5F] w-48 shadow-sm">
            ...
            <button className="bg-slate-100 border border-slate-200 p-2.5 rounded-lg text-slate-600 hover:text-slate-950 hover:bg-slate-200 transition-colors shadow-sm">
              <Filter size={14} />
            </button>
          </div>
        </div>
