    ...
    <div className="max-w-[1400px] mx-auto w-full space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-550 text-[13px] mt-1">Monitor onboarding performance and trainee milestones across the institution.</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 bg-white border border-slate-200 text-slate-650 px-4 py-2 rounded-lg font-semibold hover:bg-slate-50 transition-colors shadow-sm text-[12px] cursor-pointer">
      ...
      {/* Onboarding KPI Cards Grid */}
      <div id="onboarding" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1 */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div id="learning-journey" className="lg:col-span-2 bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden h-full flex flex-col">
          ...
          {/* Insights Section */}
          <div id="milestones" className="bg-[#6C1D5F] text-white rounded-lg p-6 shadow-sm h-full flex flex-col justify-between">
            <div>
          ...
          <div id="progress-timeline" className="lg:col-span-3 bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden h-full flex flex-col">
            <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
              <div>
