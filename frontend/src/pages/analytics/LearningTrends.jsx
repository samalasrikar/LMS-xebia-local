...
import useDashboardData from "@/modules/learning-trends/hooks/useDashboardData";
...
import TrendKPICard from "@/modules/learning-trends/components/cards/TrendKPICard";
import TrendsTable from "@/modules/learning-trends/components/tables/TrendsTable";
      ...
      {isError ? (
        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div id="monthly" className="lg:col-span-2">
              <AreaChartCard
          ...
          {/* ── Charts Row 2 ─────────────────────────────────────── */}
          <div id="growth" className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <LineChartCard
          ...
          {/* ── Charts Row 3: Heatmap & Attrition (Annual) ─────────────────── */}
          <div id="annual" className="space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
