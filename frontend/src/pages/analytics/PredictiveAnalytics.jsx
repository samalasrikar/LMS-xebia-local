  ...
  return (
    <div className="max-w-[1400px] mx-auto w-full space-y-6 animate-fadeIn">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div id="completion-prediction" className="col-span-12 lg:col-span-8 flex flex-col">
          ...
          <div id="enrollment-forecast" className="col-span-12 lg:col-span-4 flex flex-col">
          ...
          <div id="ai-recommendations" className="col-span-12 lg:col-span-4 flex flex-col">
          ...
          <div id="at-risk-learners" className="col-span-12 lg:col-span-8 flex flex-col">
            <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden h-full flex flex-col justify-between">
              <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
