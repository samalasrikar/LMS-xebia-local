...
export default function CategoryKPICard({ title, value, icon: Icon, trend, tooltip, suffix = "", prefix = "" }) {
  ...
  return (
    <motion.div
      ...
      "
    >
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#84117C] to-[#6C1D5F]" />
