...
export default function TrendKPICard({ title, value, icon: Icon, trend, tooltip, suffix = "", prefix = "" }) {
  ...
  return (
    <motion.div
      ...
      "
    >
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#01AC9F] via-[#6C1D5F] to-[#84117C]" />
