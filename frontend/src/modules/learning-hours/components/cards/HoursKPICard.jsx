...
export default function HoursKPICard({ title, value, icon: Icon, trend, tooltip, suffix = "", prefix = "" }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#6C1D5F] via-[#84117C] to-[#01AC9F]" />
