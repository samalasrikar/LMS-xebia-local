            ...
            <>
              ...
              <div className="p-4 border border-slate-200 rounded-xl bg-slate-50/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap gap-4 text-xs font-semibold text-slate-505 text-slate-500">
                  ...
                  <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider ${activeResult.status === "Pass" ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"
                    }`}>
                    {activeResult.status}
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  {activeResult.answers.map((ans, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className={`p-4 border rounded-xl relative ${isCorrect ? "border-emerald-100 bg-emerald-50/10" : "border-red-100 bg-red-50/10"
                          }`}
                      >
                        ...
                        <div className="space-y-2 pr-16">
                          ...
                          <div className="grid grid-cols-2 gap-3 text-[11px] font-semibold pt-1">
                            <div className="flex items-center gap-1">
                              ...
                              <span className={`px-1.5 py-0.5 rounded text-[10px] font-bold ${isCorrect ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"
                                }`}>
