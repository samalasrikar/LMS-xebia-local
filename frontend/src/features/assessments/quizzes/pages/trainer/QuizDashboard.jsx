...
// Modals
import CreateQuizModal from "../../components/trainer/CreateQuizModal";
import ViewResultsModal from "../../components/trainer/ViewResultsModal";
  ...
  return (
    <AppLayout>
      ...
      <DeleteDialog
        ...
        message="Are you sure you want to permanently delete this quiz assessment? This action cannot be undone."
