    ...
    return (
      ...
      ══════════════════════════════════════════════════════════ */}
            <Dialog open={blockPickerOpen} onOpenChange={setBlockPickerOpen}>
                <DialogContent className="sm:max-w-3xl rounded-xl shadow-2xl bg-white border border-slate-200 p-0 overflow-hidden">
                    {/* Search */}
                        ...
                        <div className="flex bg-slate-100 p-0.5 rounded-lg mt-3.5">
                            {[
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-1.5 text-[12px] font-bold rounded-md transition-all cursor-pointer ${courseDialogTab === tab.id
                                    ...
                                    {loadingAllCourses ? (
                                        ...
                                        return filtered.map(c => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${isCurrent ? "bg-[#6C1D5F]/10 text-[#6C1D5F]" : "bg-slate-100 text-slate-500"
                                                        }`}>
                                                        <BookOpen size={14} />
                                                    </div>
                                                    ...
                                                    <div className="flex items-center gap-2 shrink-0">
                                                        <span className={`text-[9.5px] font-bold px-2 py-0.5 rounded-full border ${c.status === "Published"
