...
import { Users, Activity, BookOpen, Star, Grid, List, Search, Filter, Plus, ChevronRight, CheckCircle2 } from "lucide-react";
      ...
      <div className="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-3">
        <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
          ...
          <Select value={statusFilter} onValueChange={handleStatusFilterChange}>
            <SelectTrigger className="h-8 w-36 bg-slate-50 border border-slate-200 text-slate-700 text-[11px] rounded-lg hover:bg-slate-100 transition-all font-semibold select-none flex items-center gap-1.5 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0">
      ...
      <Dialog open={showAddModal} onOpenChange={setShowAddModal}>
        <DialogContent className="max-w-[448px] rounded-xl shadow-2xl bg-white border border-slate-200 p-6 flex flex-col gap-4">
          <DialogHeader className="pb-2 border-b border-slate-100">
            <DialogTitle className="text-[16px] font-bold text-slate-800">Add New Trainer</DialogTitle>
          </DialogHeader>
